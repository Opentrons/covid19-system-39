...
NUM_COLS_P1 = 6  # number of columns (plate 1) (from 96 well plate, should be 1-12)
NUM_COLS_P2 = 0  # number of columns (plate 2) (from 96 well plate, should be 1-12)
NUM_COLS_P3 = 0  # number of columns (plate 3) (from 96 well plate, should be 1-12)
NUM_COLS_P4 = 0  # number of columns (plate 4) (from 96 well plate, should be 1-12)
...
def run(protocol):
    ...
    mmtips = [protocol.load_labware('opentrons_96_filtertiprack_20ul', '9')]
    tips20 = [
        protocol.load_labware(
            'opentrons_96_filtertiprack_20ul', s) for s in ['1', '4', '7', '10']
            ]
